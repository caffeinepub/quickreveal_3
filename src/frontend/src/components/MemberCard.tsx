        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-bold text-lg">{profile.tier.tierName} Member</span>
            </div>
          ...
          <div className="mb-2">
            <div className="flex justify-between items-center mb-1">
              <span className="text-white/90 text-xs font-medium">
                {nextTier ? `Progress to ${nextTier.name}` : 'Max Level Reached'}
              </span>
              {nextTier && (
                <span className="text-white/90 text-xs font-medium">
                  {nextTier.requiredXP - currentXP} XP to go
                </span>
              )}
            </div>
            <Progress 
          ...
          <div className="flex items-center gap-1 text-white/80 text-xs mt-3">
            ...
            <span>Earn 50 XP per confirmed booking</span>
          </div>
        </div>
      </CardContent>
    </Card>
